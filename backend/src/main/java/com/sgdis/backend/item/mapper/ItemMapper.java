...
public final class ItemMapper {
    ...
    public static ItemDTO toDTO(ItemEntity itemEntity) {
        return new ItemDTO(
                itemEntity.getId(),
                itemEntity.getIrId() != null ? itemEntity.getIrId() : "",
                itemEntity.getIvId() != null ? itemEntity.getIvId() : "",
                itemEntity.getProductName() != null ? itemEntity.getProductName() : "",
                itemEntity.getWareHouseDescription() != null ? itemEntity.getWareHouseDescription() : "",
                itemEntity.getLicencePlateNumber() != null ? itemEntity.getLicencePlateNumber() : "",
                itemEntity.getConsecutiveNumber() != null ? itemEntity.getConsecutiveNumber() : "",
                itemEntity.getSkuDescription() != null ? itemEntity.getSkuDescription() : "",
                itemEntity.getDescriptionElement() != null ? itemEntity.getDescriptionElement() : "",
                itemEntity.getAcquisitionDate(),
                itemEntity.getAcquisitionValue(),
                itemEntity.getAttributes() != null ? itemEntity.getAttributes() : Map.of(),
                itemEntity.getLocation() != null ? itemEntity.getLocation() : "",
                itemEntity.getResponsible() != null ? itemEntity.getResponsible() : "",
                itemEntity.getUrlsImages() != null && !itemEntity.getUrlsImages().isEmpty() ? itemEntity.getUrlsImages().get(0) : null,
                itemEntity.isStatus(),
                itemEntity.getInventory() != null ? itemEntity.getInventory().getId() : null,
                itemEntity.getInventory() != null ? itemEntity.getInventory().getName() : null
        );
    }
